$(document).ready(function(){
			...
			'<div class="modal-dialog modal-lg">' +
				...
				'<div class="modal-body">' +
					...
					'<a data-skin="skin-blur-violate" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-violate.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-lights" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-lights.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-city" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-city.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-greenish" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-greenish.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-night" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-night.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-blue" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-blue.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-sunny" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-sunny.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-cloth" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-cloth.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-tectile" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-tectile.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-chrome" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-chrome.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-ocean" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-ocean.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-sunset" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-sunset.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-yellow" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-yellow.jpg" alt="">' +
					'</a>' +
					'<a  data-skin="skin-blur-kiwi"class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-kiwi.jpg" alt="">' +
					'</a>' +
					'<a  data-skin="skin-blur-nexus"class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-nexus.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-wtf" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-wtf.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-wtf2" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-wtf2.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-wtf3" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-wtf3.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-wtf4" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-wtf4.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-wtf5" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-wtf5.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-wtf6" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-wtf6.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-wtf7" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + root + 'img/skin-wtf7.jpg" alt="">' +
					'</a>' +
				    '</div>' +
				'</div>' +
			    '</div>' +
    ...
    $('#log-in-trigger').click(function(){
		...
		//$(this).focus();          
		//$("#log-in-content").find("#username").focus();
		if ($('#signup-trigger').hasClass('active')) {
			$('#signup-trigger').toggleClass('active'); 
			$('#signup-trigger').next('#signup-content').slideToggle("fast");
			$('#signup-trigger').find('span').html('&#x25BC;')
		}
		$(this).next('#log-in-content').slideToggle("slow");
	...
	//$('nav').on('click', '#signup > a', function(){
		$(this).toggleClass('active');          
		if ($('#log-in-trigger').hasClass('active')) {
			$('#log-in-trigger').toggleClass('active'); 
			$('#log-in-trigger').next('#log-in-content').slideToggle("fast");
			$('#log-in-trigger').find('span').html('&#x25BC;')
		}
		$(this).next('#signup-content').slideToggle("slow");
		if ($(this).hasClass('active')) $(this).find('span').html('&#x25B2;')
		else $(this).find('span').html('&#x25BC;')
    });
